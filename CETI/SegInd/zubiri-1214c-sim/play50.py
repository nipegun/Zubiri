...
def fEncApagPLC(pHostPLC, pAction):
  ...
  vAntiReplay = fCalcValorAntiReplay(vPayloadParaResponderChallenge)
  vPayloadParaResponderChallenge = vPayloadParaResponderChallenge[:46]  + hex(vAntiReplay)[2] + vPayloadParaResponderChallenge[47:]
  vPayloadParaResponderChallenge = vPayloadParaResponderChallenge[:47]  + hex(vAntiReplay)[3] + vPayloadParaResponderChallenge[48:]
  vPayloadParaResponderChallenge = bytes.fromhex(vPayloadConRespuestaAlChallenge)
  if pAction == "Encender":
