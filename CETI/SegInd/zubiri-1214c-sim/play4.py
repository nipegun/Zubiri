...
def fEncApagPLC(pHostPLC, pAction):
  ...
  vPayloadConRespuestaAlChallenge = ''
  vAntiReplay = fCalcValorAntiReplay(vPayloadConRespuestaAlChallenge)
  # Preparar respuesta al challenge
  vPayloadConRespuestaAlChallenge = vPayloadConRespuestaAlChallenge[:46]  + hex(vAntiReplay)[2] + vPayloadConRespuestaAlChallenge[47:]
  vPayloadConRespuestaAlChallenge = vPayloadConRespuestaAlChallenge[:47]  + hex(vAntiReplay)[3] + vPayloadConRespuestaAlChallenge[48:]
