...
#   wget -q -N --no-cache https://raw.githubusercontent.com/nipegun/zubiri/refs/heads/main/CETI/SegInd/PLCDeClase-Interactuar2.py && python3 PLCDeClase-Interactuar.py [IPDelPLC]
#
